...
from nevise.helpers import load_vocab_dict
from nevise.helpers import batch_iter, labelize, bert_tokenize_for_valid_examples
from nevise.helpers import  untokenize_without_unks, untokenize_without_unks2, get_model_nparams
...
def spell_checking_on_sents(model, vocab, device, normalizer, txt):
    ...
    out = []
    predict_out=''
    for i in greedy_results:
        print(i)
        predict_out+=i['predicted']
    ...
    return new_out,splitters,predict_out
...
if __name__ == '__main__':
    ...
    #test
    sample_input = "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز،"
